...
namespace _25_ListBox_ComboBox
{
    ...
    {
        string[] arrNames = { "홍길동", "임꺽정", "장길산", "일지매", "차돌바위", "장옥정" };
        string[] arrWords = { "감사합니다", "고맙습니다", "사랑합니다", "존경합니다", "보고싶습니다", "행복하세요" };
        public Form1()
        {
            InitializeComponent();
        }
        ...
        {
            string str = comboBox1.SelectedItem.ToString();     // f9 : 중단점, f5 : 디버깅 / 로컬,조사식
