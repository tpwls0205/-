...
namespace _04_KeyPressInputChar
{
    public partial class Form1 : Form
    {
        ...
        {
            // 입력문자가 Backspace이면 마지막 1글자를 지워라
            if (e.KeyChar == '\b')
            {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            // 개행 문자가 적용되도록 하려고
            TextFormatFlags flags = TextFormatFlags.WordBreak; // 엔터문자를 만나면 내려써라
            string str = inputStr.ToString();
            Font f = new Font("궁서", 64);
            TextRenderer.DrawText(e.Graphics, str, Font, this.ClientRectangle, Color.DarkBlue, flags);
        }
    }
}
