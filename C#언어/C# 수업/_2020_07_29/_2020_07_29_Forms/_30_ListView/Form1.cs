...
namespace _30_ListView
{
    ...
    {
        int idx = 0; // 순서 칼럼에 들어갈 데이터
        int selStyle = 0; // 리스트 뷰 스타일 선택
        ...
        {
            string[] items = { this.idx.ToString(), tbName.Text, tbAge.Text };  // 정수를 문자열로만들때 idx.ToString();
        ...
        private void listView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            string str = "";
            for (int i = 0; i < listView1.Items[focusIndex].SubItems.Count; i++) // 현재선택된 행. 열. 개수
            {
