...
void main()
{
	...
	int totalStudentCnt = bitSeocho.getStudentCnt() + bitGangnam.getStudentCnt() 
		+ bitJongro.getStudentCnt() + bitSinchon.getStudentCnt()
		+ bitSeomyun.getStudentCnt();

	cout << "비트캠프의 총 학생수는 " << totalStudentCnt << "입니다" << endl;
}