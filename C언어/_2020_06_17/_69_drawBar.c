...
/// </summary>
/// <param name="left"> 좌단 x좌표 </param>
/// <param name="top"> 상단 y좌표 </param>
/// <param name="width"> 너비 </param>
/// <param name="height"> 높이 </param>
void drawBox(int left, int top, int width, int height)
{
	drawWall(left, left + width, 0, top, "+");				// 상단 x축
	drawWall(left, left + width, 0, top + height, "+");		// 하단 x축
	drawWall(top, top + height, 1, left, "+");				// 좌단 y축
	drawWall(top, top + height, 1, left + width, "+");		// 우단 y축
}
...
{	
	...
	while (1)
	{
		drawBox1(0, 0, 10, 5);		// 좌상단 BOX
		drawBox1(0, 25 - 5, 10, 5);	// 좌하단 BOX
		drawBox1(80 - 10, 0, 10, 5);		// 우상단 BOX
		drawBox1(80 - 10, 25 - 5, 10, 5);// 우하단 BOX
		...
		int barSx = WIDTH / 2 - strlen(bar) / 2, strlen(bar);
